...
public class StudentEnroll extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Enroll New Student Options");
        ...
        jLabel5.setText("Enrollment Year");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int enrollment_year = Integer.parseInt(jTextField4.getText());
        ...
        try {  
            ...
            PreparedStatement fpstmt = con.prepareStatement("INSERT INTO student (first_name, last_name, age, degree, enrollment_year)"
                                + " VALUES (?,?,?,?,?)");
                        
                        fpstmt.setString(1, first_name);
                        fpstmt.setString(2, last_name);
                        fpstmt.setInt(3, age);
                        fpstmt.setString(4, degree);
                        fpstmt.setInt(5, enrollment_year);
                        fpstmt.executeUpdate();
                        con.close();
                        
                        Alert.infoBox("Student: " + first_name + " successfully added!", "Success");
